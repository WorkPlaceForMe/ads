...
exports.getAds = async (req, res) => {
	try {
		...
		console.log('AUTHB64: ', authB64)
		console.log('VISTA: ', vista_url)
		console.log('USER: ', user)
		console.log('PASSWORD: ', password)
		const response = await superagent
			.post(vista_url + '/grayit/process/image/ondemand')
					...
					adsinfo: [
						{
							...
							product_price: 39,
							product_url:
								'https://www.amazon.com/WenVen-Girls-Cotton-Jackets-Removable/dp/B07BF99FQ2/ref=sr_1_4?dchild=1&keywords=brown+jacket+girl&qid=1615147300&sr=8-4',
							iframe:
