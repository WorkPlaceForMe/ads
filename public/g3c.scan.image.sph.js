...
styleEl.innerHTML = '.ui-tooltip-graymatics{background-color: #000033 !important;background:url("");font-size: 14px;font-weight: bold;opacity:0.8; color:#ffffff}';
document.head.appendChild(styleEl);

document.writeln("<script type='text/javascript' src='//code.jquery.com/ui/1.11.3/jquery-ui.js'></script>");
...
(function (a, b) {
    ...
    function d(b, c, d, e) {
        ...
        if ("indoorroom" != g.object && "person" != g.object && f.keywords != " ") {
            var topvl = c.my - 50;
            var leftvl = c.mx - 30;
            var h = "<a title='SHOP NOW!'><div class='mark' style='padding:50px; position:absolute;top:" + topvl + "px;left:" + leftvl + "px;width:24px;height:24px;'><span name='mark_point_" + E + "' style='background:url(http://scripts.graymatics.com/images/cart-icon.png) no-repeat 50% 50%;padding: 0 8px;cursor: pointer;'>&nbsp;</span></div></a>";
            a(e).append(h);
            var i = document.createElement("div");
            i.innerHTML = g.iframe, i.id = "mark_point_" + E++, i.className = "wrapper";
            var j = "position:absolute;zIndex:100;clear:both;width:240px;height:95px;padding:0.2em;background-color:#FFFFFF;display:none;border: 1px solid gray;-webkit-border-radius: 6px;-moz-border-radius: 6px;border-radius: 6px;-webkit-box-shadow: 0 2px 5px;-moz-box-shadow: 0 2px 5px;box-shadow: 0 2px 5px;";
            i.style.cssText = j;
            var k = a(e).width();
    ...
    function e() {
        a(".mark span").toggle(function () {
            var b = a(this).attr("name");
            $(".ui-corner-all").hide();
            a(this).css("background", "url(http://scripts.graymatics.com/images/circle.png) no-repeat 50% 50%"), a(".wrapper").css("z-index", "50"), a(".mark").css("z-index", "60"), a(this).css("z-index", "200"), a("#" + b).css("z-index", "100"), a("#" + b).css("display", "")
        }, function () {
            var b = a(this).attr("name");
            a(this).css("background", "url(http://scripts.graymatics.com/images/cart-icon.png) no-repeat 50% 50%"), a("#" + b).css("display", "none")
        })
    }
    function f(a, c, e) {
        for (var f = a, g = 0; f.length > g; g++) if (f[g].adsinfo != b) for (var h = 0; f[g].adsinfo.length > h; h++) {
                    var i = null,
                        ...
                        k = !1,
                        l = f[g].adsinfo[h];
                    l.focal_point !== b ? (i = l.focal_point[0] * c.cur_width / c.ori_width, j = l.focal_point[1] * (c.cur_height / c.ori_height)+150, k = !0) : (i = c.cur_width - 20 * (h + 1), j = 130, k = !1), c.mx = i, c.my = j, d(l, c, k, e)
            }
    }
    function g(b) {
        ...
        imageProcess: function () {
            ...
            if (!(200 > h.cur_width || 200 > h.cur_height)) {
                ...
                var k = g(this.celement),
                    l = this.imgsrc,
                    m = "ad_type=" + z + "&ad_width=" + A + "&ad_height=" + B + "&ad_format=" + C + "&media_type=" + w + "&url=" + l;
                a.ajax({
                    url: v,
                    type: "GET",
                    data: m,
